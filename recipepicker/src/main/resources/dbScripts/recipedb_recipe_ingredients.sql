...
CREATE TABLE `recipe_ingredients` (
  ...
  KEY `FK16js2061laahy2swxk6aubu01` (`Recipe_id`),
  CONSTRAINT `FK16js2061laahy2swxk6aubu01` FOREIGN KEY (`Recipe_id`) REFERENCES `recipe` (`id`),
...
INSERT INTO `recipe_ingredients` VALUES (1,1),(1,2),(1,3),(2,2),(2,4);
